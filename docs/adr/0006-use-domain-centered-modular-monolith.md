...
This avoids vague layering, strict Clean Architecture ceremony, plugin-style validation, and event-sourcing complexity while preserving seams needed for future remote Task Authorities, repo-local Run history, GitHub integration, and Sandcastle execution.
