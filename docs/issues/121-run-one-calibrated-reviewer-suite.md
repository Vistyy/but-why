# Run one calibrated reviewer suite
...
- Source capability: A suite reports aggregate results for one reviewer configuration against stored thresholds.
- Own repetitions, aggregation, thresholds, and stable report format.
- This task owns only the behavior demonstrated through its primary verification seam.

## What to build

A suite reports aggregate results for one reviewer configuration against stored thresholds.
...
- `docs/issues/120-evaluate-one-specialist-fixture.md`
