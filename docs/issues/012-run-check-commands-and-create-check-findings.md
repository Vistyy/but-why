...
- [ ] Command execution tooling failures use typed validation errors and are recorded as Run tooling errors, not Findings.
- [ ] Sandbox, config, and workspace failures are recorded as Run tooling errors, not Findings.
