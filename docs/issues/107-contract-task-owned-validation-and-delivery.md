# Contract Task-owned validation and delivery
...
- Source capability: The Change-centered path is the only stored model and implementation.
- Own deletion of old tables, data, TaskAuthority validation methods, writers, readers, routes, and compatibility branches.
- This task owns only the behavior demonstrated through its primary verification seam.

## What to build

The Change-centered path is the only stored model and implementation.
...
Full migration and structural test suite.
