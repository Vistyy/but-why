---
name: but-why
description: Use when setting up or operating But Why, selecting a But Why Work Route, authoring Tasks, authorizing implementation or handoff, or implementing and submitting a But Why Change.
---

# But Why

This skill is the portable workflow authority for a But Why Operator.
It owns setup guidance, But Why CLI operation, Work Route Selection, Task authoring, and authorized handoff.
