...
import { createTaskContextDraftCommand } from "../../../taskChange/composition/taskCommandOperations.js";
...
export const runContextDraftCommand = (
  ...
  return withTasks(environment, (cwd) =>
    Effect.map(createTaskContextDraftCommand(cwd, parsed.taskId), (result) => {
