...
- The failure it protects against and why that failure matters to someone maintaining the code. Describe the risk, not the history of the change that prompted the rule.
