...
export const defaultAcceptanceInstructions = [
  ...
  "For each material claim, construct a plausible wrong result and require an actual observation that would distinguish the Candidate from it.",
  "The expected result must not come from the implementation being reviewed.",
