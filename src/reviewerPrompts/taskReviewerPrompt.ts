...
export const taskReviewBuiltInInstructions = [
  ...
  "Use passing Check Artifacts instead of repeating the same broad Checks. If evidence cannot resolve a consequential question, run a proportionate targeted experiment through the exact review subject.",
  "Use real-system observations for consequential technical assumptions. Plans, intuition, test doubles, and unverified external claims do not establish them.",
  "",
  ...
  "Request a Task decision when intent must be selected or clarified. Recommend a bounded spike only when inspection cannot resolve a consequential, decision-relevant technical hypothesis; state its falsifiable hypothesis and smallest real-system experiment.",
  "",
