...
import { structuredImplementationDecisionsMigration as structuredImplementationDecisions } from "./migrations/0011_structured_implementation_decisions.js";
...
export const migrateRepositoryState = Migrator.make({})({
  loader: Migrator.fromRecord({
    ...
    "0011_structured_implementation_decisions": structuredImplementationDecisions,
  }),
});
