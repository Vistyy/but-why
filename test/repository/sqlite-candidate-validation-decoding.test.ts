    ...
    withTemporaryRepositoryState((input) =>
      Effect.gen(function* () {
        ...
        yield* repository.operation("install resolved Blocker history", (sql) =>
          Effect.gen(function* () {
            yield* sql`INSERT INTO implementation_blockers (id, change_id, reported_at, content, resolved_at, resolution_id, resolution_recorded_at, resolution_content) VALUES ('older-blocker', ${internalChangeId(prior.changeId, "BY")}, '2026-08-09T22:00:00.000Z', 'Older blocker.', '2026-08-09T22:01:00.000Z', 'older-resolution', '2026-08-09T22:01:00.000Z', 'Older resolution.')`;
            yield* sql`INSERT INTO implementation_blockers (id, change_id, reported_at, content, resolved_at, resolution_id, resolution_recorded_at, resolution_content) VALUES ('latest-blocker', ${internalChangeId(prior.changeId, "BY")}, '2026-08-09T23:00:00.000Z', 'Latest blocker.', '2026-08-09T23:01:00.000Z', 'latest-resolution', '2026-08-09T23:01:00.000Z', 'Latest resolution.')`;
          }),
        );
        expect(
        ...
        yield* repository.operation("restore absent Blocker history", (sql) =>
          Effect.gen(function* () {
            ...
            yield* sql`DELETE FROM implementation_blockers WHERE change_id = ${internalChangeId(prior.changeId, "BY")}`;
          }),
        );
